...
{
    public partial class AnswerDBContext : DbContext
    {
        public AnswerDBContext()
        {
        }

        public AnswerDBContext(DbContextOptions<AnswerDBContext> options)
            : base(options)
        {
        }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("SERVER=.;DATABASE=AnswerDB;User Id=AnswerUser;Password=Progra6");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<General>(entity =>
            {
                entity.HasKey(e => e.Idconfig)
                    .HasName("PK__General__3E2AEF2A46E52C84");
            ...
            modelBuilder.Entity<UserStatus>(entity =>
            {
                entity.HasKey(e => e.UserStatuId)
                    .HasName("PK__UserStat__DE1EE8FB604D10AD");
